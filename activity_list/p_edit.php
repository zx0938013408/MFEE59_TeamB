...
# 讀取該筆資料
$sql = "SELECT products.id, image, product_code, product_name, categories_name, product_description, price, size, color, inventory, created_at 
    FROM products
    JOIN categories 
        ...
        <div class="card-body">
          ...
          <form onsubmit="sendData(event)">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" disabled id="product_code" name="product_code" value="<?= $r['product_code'] ?>">
            ...
            <!-- <div class="mb-3">
              ...
              <select class="form-select" id="category_id" name="category_id" onchange="updateSizeOptions()">
                <option value="" disabled ><?= $r['categories_name'] ?></option>
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="category_id" name="category_id" onchange="updateSizeOptions()">
                <!-- 預設選中值 -->
                <?php $selectedCategoryId = $r['category_id'] ?? ''; ?>
                <option value="" disabled <?= $selectedCategoryId === '' ? 'selected' : '' ?>><?= $r['categories_name'] ?></option>
                <option value="1" <?= $selectedCategoryId == 1 ? 'selected' : '' ?>>上衣</option>
                <option value="2" <?= $selectedCategoryId == 2 ? 'selected' : '' ?>>褲子</option>
                <option value="3" <?= $selectedCategoryId == 3 ? 'selected' : '' ?>>鞋類</option>
                <option value="4" <?= $selectedCategoryId == 4 ? 'selected' : '' ?>>運動裝備</option>
              </select>
              <div class="form-text"></div>
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="color" name="color" value="<?= $r['color'] ?>">
              <div class="form-text"></div>
            </div>

            <div class="mb-3">
              <label for="inventory" class="form-label">庫存 *</label>
              <input type="number" class="form-control" id="inventory" name="inventory" value="<?= $r['inventory'] ?>">
              <div class="form-text"></div>
            </div>
            <div class="mb-3">
              <label for="product_description" class="form-label">商品描述 *</label>
              <textarea class="form-control" id="product_description" name="product_description" value=""><?= $r['product_description'] ?></textarea>
              <div class="form-text"></div>
            </div>
...
<script>
  // const product_nameField = document.querySelector('#product_name');
